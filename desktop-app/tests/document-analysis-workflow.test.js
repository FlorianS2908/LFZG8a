...
test('IPC-Vertrag verwendet eindeutige serialisierbare Kanäle und Payloads', () => {
  assert.deepEqual(DOCUMENT_ANALYSIS_CHANNELS, { start: 'factory:start-document-analysis', progress: 'factory:get-analysis-progress', cancel: 'factory:cancel-ai-operation', generatePlan: 'factory:generate-structured-course-plan', startPlanning: 'factory:start-course-planning', operationStatus: 'factory:get-operation-status', planningResult: 'factory:get-planning-result', aiUnderstanding: 'factory:get-ai-understanding', collaboration: 'factory:update-plan-collaboration', reviseTarget: 'factory:revise-plan-target', restoreVersion: 'factory:restore-plan-version', applyConfiguration: 'factory:apply-course-plan-configuration', classbookModel: 'factory:get-course-plan-classbook-model', exportPlan: 'factory:export-course-plan-xlsx', decideConflict: 'factory:decide-course-plan-conflict', editUnit: 'factory:edit-course-plan-unit', confirmReview: 'factory:confirm-course-plan-review', acceptReview: 'factory:accept-course-plan-review', updateTopics: 'factory:update-topic-review', confirmTopics: 'factory:confirm-topic-review' });
