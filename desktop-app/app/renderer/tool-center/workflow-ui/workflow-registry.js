  ...
  const workflows = [
    {
      ...
      steps: [
        ...
        ['courseStructure', 'KI-Analyse und Kursplanung', 'Planen', 'Dokumente analysieren und daraus die chronologische UE-Struktur erzeugen.'],
        ['structureReview', 'Analyse- und Struktur-Review', 'Review', 'Analysen, Tage, UE, Herkunft, Materialbedarf und Quellen prüfen und freigeben.'],
