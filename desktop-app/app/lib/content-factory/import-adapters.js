...
function createImportedRawFile(fileInput, now = new Date()) {
  ...
  const imported = {
    ...
    detectedType: detectTargetArea(originalFilename, fileInput.uploadArea),
    ...
    suggestedTarget: detectTargetArea(originalFilename, fileInput.uploadArea),
    selectedTarget: detectTargetArea(originalFilename, fileInput.uploadArea),
