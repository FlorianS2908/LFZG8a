const artifactContentContract = {
  ...
  requiredInputs: ['course', 'artifactTargets', 'targetAudience', 'containerProfile', 'didacticProfile'],
  ...
  didacticRules: ['Inhalt passt zu priorKnowledge und learningLevel.', 'Artefakte passen zu didacticProfile.taskProgression und supportLevel.', 'Dozentenhinweise bleiben dozent-only.'],
