...
export type DayGenerationResult = {
  ...
  tasks: Array<{ id: string; title: string; difficulty: 'easy' | 'medium' | 'hard' | 'easy_medium' | 'medium_hard' | 'all'; text: string; sourceRefs: string[]; aiGenerated: boolean }>;
  solutions: Array<{ taskId: string; title: string; text: string; sourceRefs: string[]; aiGenerated: boolean }>;
  quiz: Array<{ id: string; type: 'single-choice' | 'multiple-choice'; topic: string; difficulty: 'easy' | 'medium' | 'hard' | 'easy_medium' | 'medium_hard' | 'all'; text: string; options: string[]; correct: number[]; explanation?: string; sourceRefs: string[]; aiGenerated: boolean }>;
